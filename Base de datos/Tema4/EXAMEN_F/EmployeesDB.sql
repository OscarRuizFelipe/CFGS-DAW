...
--escriba un procesimiento almaenado que muestre el numero de departamentos que estan ubbicados en canada(CA)

DELIMITER //
CREATE PROCEDURE sp_departments_in_canada()
BEGIN
	SELECT COUNT(*) AS num_departments_in_canada	
	FROM Departments dep
	JOIN Locations loc ON dep.location_id = loc.location_id
	WHERE loc.country_id = 'CA';
END //
DELIMITER ;	
--dame la select
CALL sp_departments_in_canada();
